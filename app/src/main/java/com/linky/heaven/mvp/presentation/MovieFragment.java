...
public class MovieFragment extends BaseFragmentPresenter<MovieView> {
    ...
    private MovieView.OnActionListener mOnActionListener = new MovieView.OnActionListener() {
        ...
        @Override
        public void onOptionClick(BaseTypeBean typeBean) {
            int type = typeBean.id;
            switch (type) {
                case MovieTypeBean.ALL_INDEX:
                    bv.setContents(MovieCache.movies);
                    break;
                case MovieTypeBean.COMEDY_INDEX:
                    bv.setContents(MovieCache.ComedyMovies);
                    break;
                case MovieTypeBean.LOVE_INDEX:
                    bv.setContents(MovieCache.LoveMovies);
                    break;
                case MovieTypeBean.SUSPEND_INDEX:
                    bv.setContents(MovieCache.SuspendMovies);
                    break;
                case MovieTypeBean.TERROR_INDEX:
                    bv.setContents(MovieCache.TerrorMovies);
                    break;
                case MovieTypeBean.ACTION_INDEX:
                    bv.setContents(MovieCache.ActionMovies);
                    break;
                case MovieTypeBean.THRILLER_INDEX:
                    bv.setContents(MovieCache.ThrillerMovies);
                    break;
                case MovieTypeBean.FANTASY_INDEX:
                    bv.setContents(MovieCache.FantasyMovies);
                    break;
                case MovieTypeBean.DRAMA_INDEX:
                    bv.setContents(MovieCache.DramaMovies);
                    break;
                case MovieTypeBean.OTHERS_INDEX:
                    bv.setContents(MovieCache.OtherMovies);
                    break;
                default:
                    break;
            }
